...
class PointingTab:
    ...
    def _build(self):
        ...
        # ⭐ Phase 2/3 Debug Preview (400x300)
        Label(self.frame, text="🔴 Phase 2/3 Debug", font=("", 10, "bold")).grid(row=r, column=0, columnspan=3, pady=(10,2))
        r += 1
        ...
        self.laser_diff_label = Label(laser_frame, bg="#111", fg="#666",
                                       text="(Waiting for Phase 2/3 debug...)")
