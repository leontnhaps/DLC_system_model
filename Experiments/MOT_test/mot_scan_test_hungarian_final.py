...
def main():
    ...
    # ⭐ 유사도 로그 저장
    print("\n💾 유사도 로그 저장 중...")
    tracker.save_similarity_log("./mot_output_hungarian_final/similarity_log.txt")
    print("✅ 유사도 로그 저장 완료! → ./mot_output_hungarian_final/similarity_log.txt")
    
    # 시각화 저장
    print("\n💾 Track ID별 이미지 저장 중...")
    save_tracked_objects(tracker, output_folder="./mot_output_hungarian_final")
    print("✅ 저장 완료! → ./mot_output_hungarian_final/ 폴더 확인")
